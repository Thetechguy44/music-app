...
function(e) {
    ...
    function N(t, n, i) {
        ...
        var s = t.oClasses,
            a = e(n.nTh),
            l = (n.sWidthOrig || (n.sWidthOrig = a.attr("width") || null, (d = (a.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/)) && (n.sWidthOrig = d[1])), i !== r && null !== i && (I(i), A(p.defaults.column, i, !0), i.mDataProp === r || i.mData || (i.mData = i.mDataProp), i.sType && (n._sManualType = i.sType), i.className && !i.sClass && (i.sClass = i.className), i.sClass && a.addClass(i.sClass), d = n.sClass, e.extend(n, i), lt(n, i, "sWidth", "sWidthOrig"), d !== n.sClass && (n.sClass = d + " " + n.sClass), i.iDataSort !== r && (n.aDataSort = [i.iDataSort]), lt(n, i, "aDataSort")), n.mData),
            c = Q(l),
    ...
    function xe(t, n, r, i) {
        return t = n ? t : Se(t), r && (t = "^(?=.*?" + e.map(t.match(/["\u201C][^"\u201D]+["\u201D]|[^ ]+/g) || [""], (function(e) {
            var t;
            return '"' === e.charAt(0) ? e = (t = e.match(/^"(.*)"$/)) ? t[1] : e : "â€œ" === e.charAt(0) && (e = (t = e.match(/^\u201C(.*)\u201D$/)) ? t[1] : e), e.replace('"', "")
    ...
    function ze(n) {
        var r, i, o = n.nTable,
            ...
            m = n.oBrowser,
            v = m.bScrollOversize;
        for ((b = o.style.width) && -1 !== b.indexOf("%") && (h = b), S = 0; S < d.length; S++) null !== (r = s[d[S]]).sWidth && (r.sWidth = Ve(r.sWidthOrig, p), g = !0);
        if (v || !g && !l && !a && u == M(n) && u == f.length)
            for (S = 0; S < u; S++) {
                ...
                for (b.find("thead, tfoot").remove(), b.append(e(n.nTHead).clone()).append(e(n.nTFoot).clone()), b.find("tfoot th, tfoot td").css("width", ""), f = de(n, b.find("thead")[0]), S = 0; S < d.length; S++) r = s[d[S]], f[S].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? Ye(r.sWidthOrig) : "", r.sWidthOrig && l && e(f[S]).append(e("<div/>").css({
                    width: r.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
                ...
                if (n.aoData.length)
                    for (S = 0; S < d.length; S++) r = s[i = d[S]], e(Xe(n, i)).clone(!1).append(r.sContentPadding).appendTo(_);
                ...
                for (var w = e("<div/>").css(l || a ? {
                        ...
                        right: 0,
                        overflow: "hidden"
                    } : {}).append(b).appendTo(p), x = (l && c ? b.width(c) : l ? (b.css("width", "auto"), b.removeAttr("width"), b.width() < p.clientWidth && h && b.width(p.clientWidth)) : a ? b.width(p.clientWidth) : h && b.width(h), 0), S = 0; S < d.length; S++) {
                    var T, C = (T = e(f[S])).outerWidth() - T.width();
                    x += T = m.bBounding ? Math.ceil(f[S].getBoundingClientRect().width) : T.outerWidth(), s[d[S]].sWidth = Ye(T - C)
                }
    ...
    var St = [],
        ...
        })), p.version = "1.13.5", p.settings = [], p.models = {}, p.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0,
    ...
    function Pt(e, t, n, r) {
        var i;
        return 0 === e || e && "-" !== e ? "number" == (i = typeof e) || "bigint" == i ? e : ((e = t ? x(e, t) : e).replace && (n && (e = e.replace(n, "")), r && (e = e.replace(r, ""))), +e) : -1 / 0
    }
            ...
            _: function(t, i, o, s, a, l) {
                ...
                try {
                    ...
                    for (var s, d, g, m = f.sPageButtonDisabled, v = function(e) {
                        ...
                        if (s = i[y], Array.isArray(s)) {
                            var _ = e("<" + (s.DT_el || "div") + "/>").appendTo(r);
                            n(_, s)
                        } else {
                            switch (c = null, u = s, d = t.iTabIndex, s) {
                                case "ellipsis":
                                    r.append('<span class="ellipsis">&#x2026;</span>');
                                    break;
                                case "first":
                                    c = h.sFirst, 0 === a && (d = -1, u += " " + m);
                                    break;
                                case "previous":
                                    c = h.sPrevious, 0 === a && (d = -1, u += " " + m);
                                    break;
                                case "next":
                                    c = h.sNext, 0 !== l && a !== l - 1 || (d = -1, u += " " + m);
                                    break;
                                case "last":
                                    c = h.sLast, 0 !== l && a !== l - 1 || (d = -1, u += " " + m);
                                    break;
                                default:
                                    c = t.fnFormatNumber(s + 1), u = a === s ? f.sPageButtonActive : ""
                            }
                            null !== c && (_ = t.oInit.pagingTag || "a", g = -1 !== u.indexOf(m), ut(e("<" + _ + ">", {
...
function(e, t) {
    ...
    class W {
        ...
        _mergeConfigObj(e, t) {
            ...
            return {...this.constructor.Default, ...
                "object" == typeof n ? n : {}, ...a(t) ? $.getDataAttributes(t) : {}, ...
                "object" == typeof e ? e : {}
            }
        }
    ...
    const B = e => {
            ...
            if (!t || "#" === t) {
                ...
                n.includes("#") && !n.startsWith("#") && (n = `#${n.split("#")[1]}`), t = n && "#" !== n ? o(n.trim()) : null
            }
            return t
        },
        z = {
    ...
    class xn extends W {
        ...
        changeContent(e) {
            return this._checkContent(e), this._config.content = {...this._config.content, ...e
            }, this
        }
        toHtml() {
            const e = document.createElement("div");
    ...
    class jn extends q {
        ...
        _getTemplateFactory(e) {
            return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new xn({...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass)
    ...
    v(jn);
    const Pn = {...jn.Default, content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click"
        },
        Nn = {...jn.DefaultType, content: "(null|string|element|function)"
        };
    class Fn extends jn {
        static get Default() {
            return Pn
